<div class="bg-dark-900 dark:text-gray-200 md:grid md:grid-cols-12 rounded-t-md">
    <div class=" col-span-4 flex justify-center items-center">
        <img src="https://pyramidb.s3.ap-southeast-3.amazonaws.com/img/starRail/{{$character->portrait}}" alt="{{ $character->portrait }}"
    ...
    <div class="col-span-8">
        <div class="py-8 px-9">
            <div class="flex justify-between">
                ...
                <div class="flex gap-2">
                    <div class="flex flex-col justify-center items-center shrink">
                        <img src="https://pyramidb.s3.ap-southeast-3.amazonaws.com/img/starRail/icon/deco/rarity_{{$character->rarity}}.png"
            ...
            <div class="flex items-center gap-2 bg-dark-700 py-2 px-4 w-fit rounded-md">
                <img src="https://pyramidb.s3.ap-southeast-3.amazonaws.com/img/starRail/{{$character->paths->icon }}" alt="{{ $character->paths->name }}"
                    class="w-8 h-8">
            ...
            <div class="flex flex-col py-4 pr-1 gap-2">
                <div id="HP" class="grid grid-cols-12 items-center justify-between">
                    <div class="flex items-center gap-2 col-span-4 md:col-span-3">
                        <img src="https://pyramidb.s3.ap-southeast-3.amazonaws.com/img/starRail/icon/property/IconMaxHP.png" alt="Max HP"
                            class="w-8 h-8">
                ...
                <div id="ATK" class="grid grid-cols-12 items-center justify-between">
                    <div class="flex items-center gap-2 col-span-4 md:col-span-3">
                        <img src="https://pyramidb.s3.ap-southeast-3.amazonaws.com/img/starRail/icon/property/IconAttack.png" alt="Attack"
                            class="w-8 h-8">
                ...
                <div id="DEF" class="grid grid-cols-12 items-center justify-between">
                    <div class="flex items-center gap-2 col-span-4 md:col-span-3">
                        <img src="https://pyramidb.s3.ap-southeast-3.amazonaws.com/img/starRail/icon/property/IconDefence.png" alt="Defence"
                            class="w-8 h-8">
                ...
                <div id="SPD" class="grid grid-cols-12 items-center justify-between">
                    <div class="flex items-center gap-2 col-span-4 md:col-span-3">
                        <img src="https://pyramidb.s3.ap-southeast-3.amazonaws.com/img/starRail/icon/property/IconSpeed.png" alt="Speed"
                            class="w-8 h-8">
                ...
                <div id="Energy" class="grid grid-cols-12 items-center justify-between">
                    ...
                    <div class="w-full bg-gray-200 rounded-full h-2.5 dark:bg-dark-700 col-span-6 md:col-span-7">
                        <div class="bg-custom h-2.5 rounded-full"
                            style="width: {{ $character->getRangeEnergy(180, 110, $character->max_sp) }}%"></div>
                    </div>
                    <div class="col-span-2 flex justify-end">
