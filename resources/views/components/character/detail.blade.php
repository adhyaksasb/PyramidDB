        ...
        <div class="py-8 px-9">
            ...
            <div class="flex items-center gap-2 bg-dark-700 py-2 px-4 w-fit rounded-md">
                <img src="{{ asset('storage/starRail/' . $character->paths->icon) }}"
                    alt="{{ $character->paths->name }}" class="w-8 h-8">
            ...
            <div class="flex flex-col py-4 pr-1 gap-2">
                <div id="HP" class="grid grid-cols-12 items-center justify-between">
                    <div class="flex items-center gap-2 col-span-4 md:col-span-3">
                        <img src="{{ asset('storage/starRail/icon/property/IconMaxHP.png') }}" alt="Max HP"
                            class="w-8 h-8">
                ...
                <div id="ATK" class="grid grid-cols-12 items-center justify-between">
                    <div class="flex items-center gap-2 col-span-4 md:col-span-3">
                        <img src="{{ asset('storage/starRail/icon/property/IconAttack.png') }}" alt="Attack"
                            class="w-8 h-8">
                ...
                <div id="DEF" class="grid grid-cols-12 items-center justify-between">
                    <div class="flex items-center gap-2 col-span-4 md:col-span-3">
                        <img src="{{ asset('storage/starRail/icon/property/IconDefence.png') }}" alt="Defence"
                            class="w-8 h-8">
                ...
                <div id="SPD" class="grid grid-cols-12 items-center justify-between">
                    <div class="flex items-center gap-2 col-span-4 md:col-span-3">
                        <img src="{{ asset('storage/starRail/icon/property/IconSpeed.png') }}" alt="Speed"
                            class="w-8 h-8">
                ...
                <div id="Energy" class="grid grid-cols-12 items-center justify-between">
                    <div class="flex items-center gap-2 col-span-4 md:col-span-3">
                        <img src="{{ asset('storage/starRail/icon/property/IconEnergyLimit.png') }}" alt="Energy"
                            class="w-8 h-8">
