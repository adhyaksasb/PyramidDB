<div class="flex md:flex-row flex-col justify-center items-center gap-4 bg-dark-900 py-2 px-8 rounded-lg flex-wrap">
    <div id="rarity" class="flex bg-dark-700 rounded-lg">
        <button @if ($rarity == 4) wire:click="setRarity(null)" @else wire:click="setRarity('4')" @endif
            ...
            title="4 Star">
            <img src="{{ asset('storage/starRail/icon/deco/rarity_4.png') }}" alt="rarity_4" class="w-7 h-7">
        </button>
        <button @if ($rarity == 5) wire:click="setRarity(null)" @else wire:click="setRarity('5')" @endif
            ...
            title="5 Star">
            <img src="{{ asset('storage/starRail/icon/deco/rarity_5.png') }}" alt="rarity_5" class="w-7 h-7">
        </button>
    </div>
    <div id="element" class="flex bg-dark-700 rounded-lg">
        <button
            ...
            title="Fire">
            <img src="{{ asset('storage/starRail/icon/element/Fire.png') }}" alt="Fire" class="w-7 h-7">
        </button>
        <button
            ...
            <img src="{{ asset('storage/starRail/icon/element/Ice.png') }}" alt="Ice" class="w-7 h-7">
        </button>
        <button
            ...
            <img src="{{ asset('storage/starRail/icon/element/Imaginary.png') }}" alt="Imaginary" class="w-7 h-7">
        </button>
        <button
            ...
            <img src="{{ asset('storage/starRail/icon/element/Lightning.png') }}" alt="Lightning" class="w-7 h-7">
        </button>
        <button
            ...
            <img src="{{ asset('storage/starRail/icon/element/Physical.png') }}" alt="Physical" class="w-7 h-7">
        </button>
        <button
            ...
            <img src="{{ asset('storage/starRail/icon/element/Quantum.png') }}" alt="Quantum" class="w-7 h-7">
        </button>
        <button
            ...
            title="Wind">
            <img src="{{ asset('storage/starRail/icon/element/Wind.png') }}" alt="Wind" class="w-7 h-7">
        </button>
    </div>
    <div id="path" class="flex bg-dark-700 rounded-lg">
        <button @if ($path == 7) wire:click="setPath(null)" @else wire:click="setPath(7)" @endif
            ...
            title="Abundance">
            <img src="{{ asset('storage/starRail/icon/path/Abundance.png') }}" alt="path" class="w-7 h-7">
        </button>
        <button @if ($path == 1) wire:click="setPath(null)" @else wire:click="setPath(1)" @endif
            ...
            <img src="{{ asset('storage/starRail/icon/path/Destruction.png') }}" alt="path" class="w-7 h-7">
        </button>
        <button @if ($path == 3) wire:click="setPath(null)" @else wire:click="setPath(3)" @endif
            ...
            <img src="{{ asset('storage/starRail/icon/path/Erudition.png') }}" alt="path" class="w-7 h-7">
        </button>
        <button @if ($path == 4) wire:click="setPath(null)" @else wire:click="setPath(4)" @endif
            ...
            <img src="{{ asset('storage/starRail/icon/path/Harmony.png') }}" alt="path" class="w-7 h-7">
        </button>
        <button @if ($path == 2) wire:click="setPath(null)" @else wire:click="setPath(2)" @endif
            ...
            <img src="{{ asset('storage/starRail/icon/path/Hunt.png') }}" alt="path" class="w-7 h-7">
        </button>
        <button @if ($path == 5) wire:click="setPath(null)" @else wire:click="setPath(5)" @endif
            ...
            title="Nihility">
            <img src="{{ asset('storage/starRail/icon/path/Nihility.png') }}" alt="path" class="w-7 h-7">
        </button>
        <button @if ($path == 6) wire:click="setPath(null)" @else wire:click="setPath(6)" @endif
            ...
            <img src="{{ asset('storage/starRail/icon/path/Preservation.png') }}" alt="path" class="w-7 h-7">
        </button>
    </div>
</div>
